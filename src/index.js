...
var bvdefault = config.bvdefault;
var projectDefault = config.projectDefault;
var registerShow = require("./gtm").registerShow;
var browserName;
...
(function (window) {
    var detector = function (information) {
        ...
        var project = information.project || projectDefault;
...
function show(browserInfo) {
    registerShow(browserInfo.project, browserInfo.platform + ', ' + names[browserInfo.browser] + " v" + browserInfo.version);
